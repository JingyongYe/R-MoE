...
if __name__ == "__main__":
    ...
    parser.add_argument('--dw', action='store_true', default=False, help='Enable dynamic weighting (dw) for MoE layers')
    parser.add_argument('--dw_momentum', type=float, default=0.9)
    parser.add_argument('--min_aux_loss_weight', type=float, default=0.001)
    parser.add_argument('--max_aux_loss_weight', type=float, default=0.01)
    ...
    hparams['dw'] = args.dw
    hparams['dw_momentum'] = args.dw_momentum
    hparams['min_aux_loss_weight'] = args.min_aux_loss_weight
    hparams['max_aux_loss_weight'] = args.max_aux_loss_weight
